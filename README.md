...
學習HelloStreamlit.ipynb，到產出 QR Code的過程，
整理了這份詳細的教學指南，特別加入了學習歷程檔案的撰寫建議與口試委員實境模擬的亮點說明。

第一階段：獲取老師的範本 (10 分鐘)
進入老師專案：點擊老師提供的 GitHub 網址：https://github.com/PeterShiaush/Hello-Streamlit。
